    ...
    <nav>
        ...
        <ul>
            <li class="active open">
                <a href="#" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">بيانات عامه</span></a>
                <ul>
                    <li class="active">
                        <a href="index.html" title="Dashboard"><span class="menu-item-parent">Analytic s Dashboard</span></a>
                    </li>
                    <li>
            ...
            <li class="">
                ...
                <ul>
                    <li class="active">
                        <a href="{{route('view_tickets')}}" title="Dashboard"><span class="menu-item-parent">عرض التذاكر</span></a>
                    </li>
                    <li>
                        <a href="dashboard-marketing.html" title="Dashboard"><span class="menu-item-parent">حالة الموظفون</span></a>
                    </li>
                    <li>
                        <a href="dashboard-social.html" title="Dashboard"><span class="menu-item-parent">Social Wall</span></a>
                    </li>
            ...
            <li class="">
                <a href="#" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">العملاء</span></a>
                <ul>
                    <li class="active">
                        <a href="{!! route('customers') !!}" title="Dashboard"><span class="menu-item-parent">العملاء / الزبائن</span></a>
                    </li>
                    <li>
                        <a href="dashboard-marketing.html" title="Dashboard"><span class="menu-item-parent">حالة الموظفون</span></a>
                    </li>
